...
def main(folding_id, inliner_classes, total_classes, folds=5):
    ...
    def compute_threshold(mnist_valid, percentage):
        ...
        for e in np.arange(minP, maxP, 0.1):
            ...
            true_negative = np.sum(np.logical_and(np.logical_not(y), not_novel))
##            print (true_positive)
##            print (false_positive)
##            print (false_negative)
##            print (true_negative)# + false_positive)# + false_negative)# + true_negative)
##            xx
...
##        print(len(mnist_test_outlier))
##        print(len(mnist_test_inliner))
        ...
        #print (true_positive,true_negative, count)
